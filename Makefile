...
create_manual:
	@if [ $(UNAME_S) = "Darwin" ]; then \
		...
		cp manpages/pokemon_server.1 usr/share/man/man1/pokemon_server.1; \
		gzip usr/share/man/man1/pokemon_server.1 \
		cp manpages/pokemon_client.1 usr/share/man/man1/pokemon_client.1; \
		gzip usr/share/man/man1/pokemon_client.1 \
		echo OK; \
	fi
